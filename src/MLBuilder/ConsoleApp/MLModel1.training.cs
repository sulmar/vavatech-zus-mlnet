...
namespace ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\marci\Projects\vavatech-zus-mlnet\src\BinaryClassification\XSSDefenderTrainer\XSS_dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(@"Id", @"Id")      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Sentence",outputColumnName:@"Sentence"))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Id",@"Sentence"}))      
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=20,NumberOfTrees=4,MaximumBinCountPerFeature=254,FeatureFraction=1,LearningRate=0.09999999999999998,LabelColumnName=@"Label",FeatureColumnName=@"Features",DiskTranspose=false}));
